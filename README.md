...
🌐 **[🖥️ VAI ALLA PAGINA DEL PROGETTO](./01-Filtro-Laplaciano-FPGA/)** 📖 *Contiene la spiegazione delle 3 versioni hardware, l'albero CSA e la [Relazione Tecnica in PDF](./01-Filtro-Laplaciano-FPGA/docs/Relazione_PSD.pdf).*
